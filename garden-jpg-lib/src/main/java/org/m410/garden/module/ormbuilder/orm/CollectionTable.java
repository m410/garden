 ...
 */
public final class CollectionTable extends Node {
    private String name =  "";
    ...
    public CollectionTable(String name, String catalog, String schema) {
        this();
        this.name = name;
    ...
    public CollectionTable(String name) {
        this();
        this.name = name;
    }

    public CollectionTable withChildren(Node... nodes) {
    ...
    public void appendElement(Document root, Element parent) {
        Element basic = root.createElement("collection-table");
    ...
    public boolean equals(Object obj) {
        ...
        CollectionTable rhs = (CollectionTable) obj;
